...
#### (x) 実行環境とデータ管理<br>
(x.1) ユーザーデータフォルダ (\UserData\EBWebView)<br>
...
(x.3) VBA側の堅牢な3段階監視（SendAndReceive）<br>
